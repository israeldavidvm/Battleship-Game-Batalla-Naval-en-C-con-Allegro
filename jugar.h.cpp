    ...
    if(is_inside_bitmap (menu, mouse_x, mouse_y-(SCREEN_H-120), 1)){
        if((((mouse_x>=0 && mouse_x<=60)&&(mouse_y>=SCREEN_H-120 && mouse_y<= SCREEN_H-90)))&& !selec1){
            if(mouse_b  & 1){
                ...
                flota[cont].mapaDBits2=load_bitmap("elbuque.bmp",NULL);
                barco=load_bitmap("buqueT.bmp",NULL);
                }
                rest(500);
            ...
            if((mouse_b  & 1)){
                ...
                flota[cont].mapaDBits2=load_bitmap("elsubmarino.bmp",NULL);
                barco=load_bitmap("submarinoT.bmp",NULL);
                }
                rest(500);
            ...
            if((mouse_b  & 1)){
                ...
                flota[cont].mapaDBits2=load_bitmap("elfragata.bmp",NULL);
                barco=load_bitmap("fragataT.bmp",NULL);
                }
                rest(500);
            ...
            if(mouse_b  & 1){
                ...
                flota[cont].mapaDBits2=load_bitmap("elacorazado.bmp",NULL);
                barco=load_bitmap("acorazadoT.bmp",NULL);
                }
                rest(500);
            ...
            if((mouse_b  & 1)){
                ...
                flota[cont].mapaDBits2=load_bitmap("elportaaviones.bmp",NULL);
                barco=load_bitmap("portaT.bmp",NULL);
...
void cargarImagenes(){
    anuncio=load_bitmap("Averia.bmp",NULL);
    fondo = load_bitmap("fondo.bmp",NULL);
    cursor = load_bitmap("cursor.bmp",NULL);
    oceano=load_bitmap("tableroJ.bmp",NULL);
    menu=load_bitmap("tablero.bmp",NULL);
    explosion=load_bitmap("hundido.bmp",NULL);
    fallo=load_bitmap("fallo.bmp",NULL);

    buqueM=load_bitmap("buqueT.bmp",NULL);
    submarino=load_bitmap("submarinoT.bmp",NULL);
    fragata=load_bitmap("fragataT.bmp",NULL);
    acorazado=load_bitmap("acorazadoT.bmp",NULL);
    portaA=load_bitmap("portaT.bmp",NULL);
